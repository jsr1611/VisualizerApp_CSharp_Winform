...
namespace VisualizerApp_3
{
    public partial class UserControl2 : UserControl
    {
        ...
        public UserControl2(string[] timeInterval, List<List<List<string[]>>> graphDataAll, List<int> ids, string whatToShow)
        {
            InitializeComponent();
            ...
            LiveCharts.WinForms.CartesianChart[] cartesianCharts = { cartesianChart2, cartesianChart4, cartesianChart1, cartesianChart3 };
